...
IB_REQUIRED_FIELDS = ('instance-id', 'availability-zone', 'local-hostname')
...
class DataSourceIBGCE(sources.DataSource):
    ...
    # IBGCE takes sshKeys attribute in the format of '<user>:<public_key>'
    ...
    def launch_index(self):
        # IBGCE does not provide lauch_index property
        return None
